...
def move_doc_to_shelf():
    ...
    return 'Документ номер "{}" был перемещен на полку номер "{}"'.format(user_doc_number, user_shelf_number) # for delete, testing change
...
def show_document_info(document):
    ...
    return '{} "{}" "{}"'.format(doc_type, doc_number, doc_owner_name)  # for delete, testing change


def show_all_docs_info():
    print('Список всех документов:\n')
    out_test_list =[]                                                   # for delete, testing change
    for current_document in documents:
        # show_document_info(current_document)
        out_test_list.append(show_document_info(current_document))      # for delete, testing change
    return out_test_list                                                # for delete, testing change
